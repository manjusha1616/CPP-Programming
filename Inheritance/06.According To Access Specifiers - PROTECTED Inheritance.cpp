//According To Access Specifiers - PROTECTED Inheritance
...
int main()
{
    ...
    //Obj.a = 21;                 //Not Allowed Bcoz Class Is Derived Protectedly
    //Obj.b = 51;                 //Not Allowed Bcoz Class Is Derived Protectedly
